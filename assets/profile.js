document.addEventListener("DOMContentLoaded", () => {
  const courseData = [
    { title: "Introduction to C Programming", lessons: [{ xp: 50 }] },
    { title: "Operators", lessons: [{ xp: 75 }] },
    { title: "Selection", lessons: [{ xp: 100 }] },
    { title: "Repetition", lessons: [{ xp: 100 }] },
    { title: "String Manipulation", lessons: [{ xp: 120 }] },
    { title: "Pointer and Array", lessons: [{ xp: 150 }] },
    { title: "Midterm Exam Simulation", lessons: [{ xp: 200 }] },
    { title: "Function", lessons: [{ xp: 100 }] },
    { title: "Recursion", lessons: [{ xp: 125 }] },
    { title: "Structures", lessons: [{ xp: 120 }] },
    { title: "File Processing", lessons: [{ xp: 150 }] },
    { title: "Sorting 1", lessons: [{ xp: 130 }] },
    { title: "Sorting 2", lessons: [{ xp: 150 }] },
    { title: "Searching", lessons: [{ xp: 120 }] },
    { title: "Final Exam Simulation", lessons: [{ xp: 300 }] },
  ];
  ...
  const showNotification = (message) => {
    ...
    setTimeout(() => successNotification.classList.add("translate-y-20", "opacity-0"), 3000);
  };
  ...
  updateUsernameForm.addEventListener("submit", (e) => {
    ...
    if (userIndex !== -1) users[userIndex].username = newUsername;
  ...
  resetProgressBtn.addEventListener("click", () => {
    const isConfirmed = confirm("Reset semua progres? Ini ga bisa dibatalin lho.");
    if (isConfirmed) {
      const loggedInUsername = localStorage.getItem("loggedInUser");
      if (loggedInUsername) {
        const progressKey = `userProgress_${loggedInUsername}`;
