document.addEventListener("DOMContentLoaded", () => {
  // setup animasi 3D di background hero
  ...
  // accordion FAQ (sama kayak outline tapi dipisah karena beda class)
  ...
  // smooth scroll buat link navbar
  ...
  // efek tilt kartu FAQ juga (sama tapi lebih subtle)
