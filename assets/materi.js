document.addEventListener('DOMContentLoaded', () => {
    ...
    const courseData = [
        // CHAPTER 1
        { lessons: [{ 
            title: 'Pengenalan Bahasa C', xp: 50, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3ZXJ5MWo4ZWZ1eno5bmxmMjNkbXdsbnR1dWFkbHhzNDBtbjJsaXQ1eCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/szaTML0LZFAQa3do7Y/giphy.gif',
...
int main() {
    ...
    return 0;
            ...
            output: `Hello, World!`,
            videoSrc: 'videos/c_intro.mp4' 
        }]},

        // CHAPTER 2
        { lessons: [{ 
            title: 'Mengenal Operator di C', xp: 75, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3ZXVmdnJyaWM2YzZwN3k0NWtna3hoZHo3ZmVzNmY3OXFrcnJndG9sbiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/26xBBBHZVnC2zloGI/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 3
        { lessons: [{ 
            title: 'Struktur Seleksi (If-Else & Switch)', xp: 100, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3dDRqZXlvenQ5ZGhzZDIxM21ueHY3bjF3NXRnd282ZHB0a3czYXA1YyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/iegwoAJoMBa1xLr6De/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 4
        { lessons: [{ 
            title: 'Struktur Perulangan (For, While, Do-While)', xp: 100, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3dDRqZXlvenQ5ZGhzZDIxM21ueHY3bjF3NXRnd282ZHB0a3czYXA1YyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/hoIFd5c6YIAFv8yedH/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 5
        { lessons: [{ 
            title: 'Manipulasi String', xp: 120, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3NWR6czVpcDJ3aGhoZTRwaTlrY2pyaTZlajBnaHg3MzRoZGEwMHAzcyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/3ov9k27tmt0r5z5B16/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 6
        { lessons: [{ 
            title: 'Pointer dan Array', xp: 150, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bHl3ejFucjU1aGZpYWR1b204dWlvd3B3d3V2ODluMDloeTIydDlvdCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/wyggNMYdS6uVG/giphy.gif',
...
int main() {
    ...
    *ptrNilai = 90;
    ...
    return 0;
        ...
        // CHAPTER 7
        { lessons: [{ 
            title: 'Simulasi Ujian Tengah Semester', xp: 200, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3OGVxcGxkdGFtMnE2ejRyajhoaDh4ZnRlaHNpcHdwMjIzbnZuc3kwYSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/7bCBsz5VYuqU5Fk7d6/giphy.gif',
...
// Tulis kode Anda di sini...`,
        ...
        // CHAPTER 8
        { lessons: [{ 
            title: 'Membuat dan Menggunakan Fungsi', xp: 100, 
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3c3R4Z2RjZ3lpbXpuMGY2aTVqN203Nm02YmxycnYzazRlOHp5dnU3YyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/DHBGehJ3FSZEygszX3/giphy.gif',
...
float hitungLuasPersegiPanjang(float panjang, float lebar) {
    ...
    return panjang * lebar;
        ...
        { lessons: [{
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3c3R4Z2RjZ3lpbXpuMGY2aTVqN203Nm02YmxycnYzazRlOHp5dnU3YyZlcD12MV9naWZzX3NlYXJjaCZjdD1n/7Tzup7ATZEuMVwZ4Te/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 10
        { lessons: [{
            title: 'Bekerja dengan Struct', xp: 120,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3MHhrcGpjbnI0cWZxb2FwOXU4N3o5eWFweG9ocjBoMDNqN2dmYWkydCZlcD12MV9naWZzX3NlYXJjaCZjdD1n/hXgDWPI2M5X9sVPlpp/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 11
        { lessons: [{
            title: 'Membaca dan Menulis File', xp: 150,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3MXJoejJjYWVsNDJmaHNrbDh2NmQxeWtrZTVuYXBmNG0yN3AyOXg0ZiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/L4HhVNOsxzsT6XFmWv/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 12
        { lessons: [{
            title: 'Algoritma Sorting Dasar', xp: 130,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3bWVoMWVmdTBjN3pvOHAzN2YybDNpYmlia3U2MWQ0ZXVuM2R6Y3kyNSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/ea74cjF0jieXu/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 13
        { lessons: [{
            title: 'Algoritma Sorting Lanjutan', xp: 150,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3ZXBuaWgzbnNmb2hkMmJ4Zm5peXI1ZGR6bXQzbnEyd2VlN2p3ZW16MiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/BCK1i9BrGz8UkFGuq4/giphy.gif',
...
printf("Quick Sort adalah algoritma yang sangat efisien!\\n");`,
        ...
        // CHAPTER 14
        { lessons: [{
            title: 'Algoritma Pencarian', xp: 120,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3ZXBuaWgzbnNmb2hkMmJ4Zm5peXI1ZGR6bXQzbnEyd2VlN2p3ZW16MiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/ssTuHIyG3cF2VCPIa4/giphy.gif',
...
int main() {
    ...
    return 0;
        ...
        // CHAPTER 15
        { lessons: [{
            title: 'Simulasi Ujian Akhir Semester', xp: 300,
            ...
            gifSrc: 'https://media.giphy.com/media/v1.Y2lkPWVjZjA1ZTQ3cHJ1dmVteGgyeTU4bzZuZHM4aHI3aW4xcmhhdmczMnFyemN5OGMwaiZlcD12MV9naWZzX3NlYXJjaCZjdD1n/pKFpaOoSzMfCFgXvyA/giphy.gif',
...
int main() {
    ...
    const loadLessonContent = () => {
        ...
        if(videoSourceEl && lessonToShow.videoSrc) {
           videoSourceEl.src = lessonToShow.videoSrc;
           document.querySelector('#lesson-video').load();
        } else if (watchVideoBtn) {
           watchVideoBtn.parentElement.parentElement.classList.add('hidden');
        }
